...
At the end of each generated statement, make the last parameter is the date and time(as a 4 digit number representing hour and minute) in 
which the statement has been added. Therefore, the new facts you generate should have the current data applied to it as a list. Also make sure 
